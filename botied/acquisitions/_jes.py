...
class JES(BaseAcquisition):
    ...
    def select_subset(
        ...
        for _ in tqdm(range(q_batch_size), desc=self.__class__.__name__):
            ...
            scores[exclude] = -np.inf  # acq value can be negative for JES
            # Find best in batch
    ...
    def optimize(
        ...
        of the JES acquisition function, and returns a new candidate and
        observation."""
        total_retries = 100
